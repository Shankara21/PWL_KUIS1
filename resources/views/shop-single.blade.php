        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="{{ asset($barang->image) }}" alt="Card image cap" id="product-detail">
                    </div>
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">{{ $barang->name }}</h1>
                            <p class="h3 py-2">${{ $barang->price }}</p>
                            <p class="py-2">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>{{ $barang->brand }}</strong></p>
                                </li>
                            </ul>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>{{ $barang->color }}</strong></p>
                                </li>
                            </ul>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            ...
                                            <li class="list-inline-item"><span class="btn btn-success btn-size">{{ $barang->size }}</span></li>
                                        </ul>
                                    </div>
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
