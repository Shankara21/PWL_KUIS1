    ...
    <div class="container pb-5">
        <div class="row">
            <div class="col-lg-5 mt-5">
                <div class="card mb-3">
                    <img class="card-img img-fluid" src="{{ asset($barang->image) }}" alt="Card image cap"
                        id="product-detail">
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">
                                <p class="text-muted"><strong>{{ $barang->supplier->nama_supplier }}</strong></p>
                            </li>
                        </ul>
                                ...
                                <div class="col-auto">
                                    <ul class="list-inline pb-3">
                                        ...
                                        <li class="list-inline-item"><span
                                                class="btn btn-success btn-size">{{ $barang->size }}</span></li>
                                    </ul>
                                </div>
                                <div class="col-auto">
                                    <ul class="list-inline pb-3">
