            ...
            <ul class="list-unstyled templatemo-accordion">
                <li class="pb-3">
                    ...
                    <ul id="collapseThree" class="collapse list-unstyled pl-3">
                        ...
                        <li><a class="text-decoration-none" href="/shop?category={{ $category->slug }}">{{ $category->name }}</a></li>
                        @endforeach
                    </ul>
                </li>
            </ul>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 product-wap rounded-0">
                        <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" style="height: 300px" src="{{ asset($barang->image) }}">
                            <div
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-center mb-0">${{ $barang->price }}</p>
                        </div>
                    </div>
                </div>
                @endforeach
