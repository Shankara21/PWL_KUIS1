        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card h-100">
                    <a href="/single/{{ $barang->slug }}">
                        <img style="height: 400px" src="{{ asset($barang->image) }}" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body">
                        <ul class="list-unstyled d-flex justify-content-between">
                            ...
                            <li class="text-muted text-right">${{ $barang->price }}</li>
                        </ul>
                        <a href="shop-single.html" class="h2 text-decoration-none text-dark">{{ $barang->name }}</a>
                        <p class="card-text">
                            {{ $barang->description }}
                        </p>
                    </div>
